    ...
    <?php
      ...
      <section class="container page">
        ...
        <div class="mx-auto" style="width: 200px;">
          <a class="btn btn-danger btn-lg" href="alumnosLogin.html" role="button">Regresar a Alumnos</a>
        </div>
      ...
      $ssql= "INSERT INTO alumnos VALUES ('$matricula','$nombre','$apellido','$contrasena')";
